...
print("Iniciando a validação cruzada para Random Forest...")
...
print("\n--- Resultados Finais da Validação Cruzada (Random Forest) ---")
...
if len(y_true_all) > 0 and len(set(y_true_all)) == 2:
    ...
    plt.title('Curva ROC da Validação Cruzada - Random Forest')
