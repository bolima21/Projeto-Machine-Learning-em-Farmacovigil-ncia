...
print("Iniciando a validação cruzada para Redes Neurais (MLP)...")
...
print("\n--- Resultados Finais da Validação Cruzada (Redes Neurais) ---")
...
if len(y_true_all) > 0 and len(set(y_true_all)) == 2:
    ...
    plt.title('Curva ROC da Validação Cruzada - Redes Neurais (MLP)')
