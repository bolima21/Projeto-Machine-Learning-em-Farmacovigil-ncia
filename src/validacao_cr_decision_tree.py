...
print("Iniciando a validação cruzada para Decision Tree...")
...
print("\n--- Resultados Finais da Validação Cruzada (Decision Tree) ---")
...
if len(y_true_all) > 0 and len(set(y_true_all)) == 2:
    ...
    plt.title('Curva ROC da Validação Cruzada - Decision Tree')
